...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $books->resume = addslashes("Un roman de l'écrivain argentin Paulo Coelho, qui raconte l'histoire d'un écrivain qui se met à la recherche de son épouse disparue, qui est devenue son 'Zahir'. Le livre explore des thèmes tels que l'amour, la liberté, la jalousie, la célébrité et l'identité");
        $books->prix = 5500;
        $books->genre_id=7;
        $books->auteur_id = 17;
        $books->save();
        ...
        $books->resume = addslashes("Un roman de l'écrivain brésilien Paulo Coelho, qui raconte l'histoire d'un berger espagnol nommé Santiago, qui voyage en Égypte à la recherche d'un trésor caché. Le livre explore des thèmes tels que la poursuite de son destin, la poursuite de ses rêves, l'importance de l'écoute de son cœur, et l'omniprésence de Dieu.");
        $books->prix = 6500;
        $books->genre_id=7;
        $books->auteur_id = 17;
        $books->save();
        ...
        $books->titre = 'Segu';
        $books->resume = addslashes("Un roman historique de l'écrivaine guadeloupéenne Maryse Condé, qui décrit la vie dans le royaume Bambara de Ségou au 18ème siècle, avant l'arrivée des colons européens. Le livre explore des thèmes tels que la politique, la religion, la famille, la culture, l'esclavage et la résistance.");
        $books->prix = 4500;
        $books->auteur_id = 18;
        $books->genre_id=9;
        $books->save();
        ...
        $books->resume = addslashes("Un livre pour enfants de la série 'Les Six Compagnons' écrite par l'auteur français Paul-Jacques Bonzon, qui suit les aventures de six amis qui résolvent des mystères. Dans ce livre, ils enquêtent sur une série de cambriolages dans un camping.");
        $books->prix = 3500;
        $books->genre_id=8;
        $books->auteur_id = 19;
        $books->save();
        ...
        $books->resume = addslashes(" Un livre pour enfants de la série 'Les Six Compagnons' écrit par l'auteur français Paul-Jacques Bonzon, où les six amis visitent Lyon et enquêtent sur une série de vols dans un funiculaire.");
        $books->prix = 3500;
        $books->genre_id=8;
        $books->auteur_id = 19;
        $books->save();
        ...
        $books->resume = addslashes(" Un livre pour enfants de la série 'Le Club des Cinq' écrite par l'auteur britannique Enid Blyton, qui suit les aventures de quatre enfants et de leur chien. Dans ce livre, ils se rendent sur une île pour enquêter sur un trésor caché.");
        $books->prix = 3000;
        $books->genre_id=8;
        $books->auteur_id = 20;
        $books->save();
        ...
        $books->resume = addslashes("Un livre pour enfants de la série 'Le Club des Cinq' écrit par l'auteur britannique Enid Blyton, où les quatre enfants et leur chien passent des vacances à la plage et enquêtent sur une série de cambriolages.");
        $books->prix = 3000;
        $books->genre_id=8;
        $books->auteur_id = 20;
        $books->save();
